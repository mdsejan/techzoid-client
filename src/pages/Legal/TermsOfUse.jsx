  ...
  return (
    <div className="max-w-screen-lg min-h-screen mx-auto py-16">
      <div className="container mx-auto p-8 rounded ">
        ...
        <h2 className="text-lg font-semibold mb-4">2. Use License</h2>
        <p className="mb-4">
        ...
        <h2 className="text-lg font-semibold mb-4">3. Disclaimer</h2>
        <p className="mb-4">
        ...
        <h2 className="text-lg font-semibold mb-4">4. Limitations</h2>
        <p className="mb-4">
        ...
        <h2 className="text-lg font-semibold mb-4">5. Revisions and Errata</h2>
        <p className="mb-4">
        ...
        <h2 className="text-lg font-semibold mb-4">6. Links</h2>
        <p className="mb-4">
          We have not reviewed all of the sites linked to its website and is not
